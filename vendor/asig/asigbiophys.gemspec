Gem::Specification.new do |s|
  ...
  s.description = %q{ASIGBiophys provides biophysical calculators for use in agriculture and related disciplines.}
  s.files = [ "README", "CHANGELOG", "LICENSE", "lib/et_calculator.rb", "lib/ad_calculator.rb"]
end
